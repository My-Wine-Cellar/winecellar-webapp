...
INSERT INTO wine (name, vintage, size, weblink, producer_id, closure_id, shape_id, color_id) VALUES ('Opus One', 2015, 0.75, 'https://www.opusonewinery.com/wine/', 1, 1, 4, 2);
...
INSERT INTO wine (name, vintage, size, alcohol, acid, bottle_aging, weblink, producer_id, closure_id, shape_id, color_id) VALUES ('Brunello di Montalcino', 2013, 0.75, 14.0, 5.6, 240, 'https://www.poggioantico.com/product/brunello-di-montalcino/', 2, 1, 1, 2);
...
-- Madre
INSERT INTO wine (name, vintage, size, alcohol, acid, bottle_aging, weblink, producer_id, closure_id, shape_id, color_id) VALUES ('Madre', 2016, 0.75, 14.5, 5.7, 120, 'https://www.poggioantico.com/product/madre/', 2, 1, 1, 1);
