...
-- Poggio Antico
INSERT INTO producer (name, phone, fax, email, description, website) VALUES ('Poggio Antico', '+39 0577-848044', '+39 0577-846563', 'mail@poggioantico.com', 'Poggio Antico, Tuscany', 'https://www.poggioantico.com/en/');
INSERT INTO area_producer (area_id, producer_id) VALUES (704, 2);
-- Brunello di Montalcino
INSERT INTO wine (name, vintage, size, alcohol, acid, bottle_aging, weblink, producer_id, closure_id, shape_id, color_id, type_id) VALUES ('Brunello di Montalcino', 2013, 0.75, 14.0, 5.6, 240, 'https://www.poggioantico.com/en/wines/brunello-di-montalcino', 2, 1, 1, 2, 1);
...
-- Madre
INSERT INTO wine (name, vintage, size, alcohol, acid, bottle_aging, weblink, producer_id, closure_id, shape_id, color_id, type_id) VALUES ('Madre', 2016, 0.75, 14.5, 5.7, 120, 'https://www.poggioantico.com/en/wines/madre', 2, 1, 1, 2, 1);
