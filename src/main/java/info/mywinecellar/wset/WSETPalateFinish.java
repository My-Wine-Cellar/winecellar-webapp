...
@Setter
@Entity
@Table(name = "wset_palate_finish")
public class WSETPalateFinish extends BaseEntity implements Comparable<WSETPalateFinish> {
     ...
     * @param name The name
     */
    public WSETPalateFinish(String name) {
        this.name = name;
    }
    ...
    @Override
    public int compareTo(WSETPalateFinish w) {
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof WSETPalateFinish)) {
            return false;
        }
